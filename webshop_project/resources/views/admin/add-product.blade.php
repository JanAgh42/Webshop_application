    ...
    <article class="col-span-5 mx-auto sm:col-span-4 w-full py-5 lg:px-5 lg:ml-4 rounded-b-md border border-[var(--color-light)] primary-color">
      ...
      <section class="formular-container mx-auto bg-white fit-content w-fit p-10 m-5">
        <div class="title-container mb-8">
          <h1 class="text-3xl font-bold">Pridať nový produkt</h1>
        </div>
        <form action="/admin/product/add" method="POST" class="w-full max-w-lg">
          @csrf
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3 mb-6 md:mb-0">
              ...
              <input name="name" class="block border border-grey-light w-full p-2 rounded-md mb-4 focus:outline-none" id="product-name" type="text" placeholder="iPhone 5">
              @if($errors->has('name'))
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input name="price" class="block border border-grey-light w-full p-2 rounded-md mb-4 focus:outline-none" id="product-price" type="number" placeholder="950.00">
            ...
            <div class="w-full px-3 mb-6 md:mb-0 flex content-center max-[500px]:flex-col">
              ...
              <div class="w-full">
                ...
                <input name="discount" class="block border border-grey-light w-full p-2 rounded-md mb-4 focus:outline-none" id="product-discount" type="number" placeholder="42.5" oninput="detectInvalidValues()" disabled>
          ...
          <div class="w-full md:w-full mb-10">
            ...
            <textarea name="description" class="block border border-grey-light w-full p-2 rounded-md mb-4 focus:outline-none" id="product-description" type="number" placeholder="Tento produkt ma 256GB pamäte..."></textarea>
          </div>

          <section class="text-center mt-10">
            <input type="submit" class="inline-flex px-5 justify-center rounded-md bg-green-700  py-3 text-sm font-semibold text-white shadow-sm hover:bg-green-500 sm:ml-3 sm:w-auto hover:cursor-pointer" text="Pridat produkt" value="Vytvoriť">
          </section>
        </form>
        ...
        <form action="/admin/clear-session" method="POST" class="text-center">
          @csrf
          <input type="submit" value="Uložiť zmeny" class="colored-button p-3 bg-[var(--color-button)] hover:cursor-pointer bg-green-700 rounded-md text-white shadow-sm text-sm font-semibold" />
        </form>
        @endif
        @endif
